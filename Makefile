...
.PHONY: lint-all lint-dockerfile lint-go lint-sh lint-yaml
lint-all: docker-lint-dockerfile docker-lint-go docker-lint-sh docker-lint-yaml ## Run all possible linters
